...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21-Fev-2023 às 22:51
...
--
-- Estrutura da tabela `code_troca_senha`
--

CREATE TABLE `code_troca_senha` (
  `id` int(255) NOT NULL,
  `code` varchar(255) NOT NULL,
  `data_hora_add` varchar(255) NOT NULL,
  `status` varchar(255) NOT NULL,
  `data_hora_finalizado` varchar(255) DEFAULT NULL,
...
CREATE TABLE `desenhos` (
  ...
  `cortador` varchar(255) DEFAULT NULL,
  `data_hora_add` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `desenhos_temp` (
  ...
  `data_add` varchar(255) NOT NULL,
  `data_finalizado` varchar(20) DEFAULT NULL,
  `status` varchar(255) NOT NULL,
...
(5, 'luemn', '3', 'ativo', 'santana', '08/02/2023 16:47:10');
...
(25, '11', 'ativo', '1', '10/02/2023 18:59:37'),
(26, '111', 'ativo', '1', '10/02/2023 18:59:38'),
(27, '1111', 'ativo', '1', '10/02/2023 18:59:38'),
(28, '2', 'ativo', '1', '10/02/2023 18:59:42'),
(29, '3', 'ativo', '1', '10/02/2023 18:59:43'),
(30, '4', 'ativo', '1', '10/02/2023 18:59:48');
...
INSERT INTO `tokens` (`id`, `code`, `data_hora_add`, `local`) VALUES
(1, 'fc647bacafc32015bf05265aa6d65b36', '15/02/2023 16:02:54', 'whatsapp');
...
INSERT INTO `usuarios` (`id`, `nome`, `senha`, `tipo`, `status`, `individuo`, `data_hora_add`, `whatsapp`, `email`) VALUES
(1, 'santana', '202cb962ac59075b964b07152d234b70', 'adm', 'adm', '', '', '554796444794', '12');
...
--
-- Índices para tabela `code_troca_senha`
--
ALTER TABLE `code_troca_senha`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `code_troca_senha`
--
ALTER TABLE `code_troca_senha`
