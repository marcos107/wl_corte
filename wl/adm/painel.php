...
function tabela($valores, $valores1, $titulo, $itens, $nomes_itens, $php)
{
...
menu($_SESSION['usuario'], '<li><input type="submit" name="filtros" value="Filtro" /></li>
<li><input type="submit" name="empreendimento" value="empreendimento" /></li><li><input type="submit" name="empresa" value="empresa" /></li><li><input type="submit" name="finalidade" value="finalidade" /></li><li><input type="submit" name="prioridade" value="prioridade" /></li><li><input type="submit" name="usuarios" value="usuario" /></li><li><input type="submit" name="desenho" value="Desenhos" /></li>');
echo '<div class="main">';
...
if (true) { //filtros
    if (isset($_POST['filtros']) || isset($_SESSION['filtros'])) {
        ...
        <td><input type="submit" name="add_filtros" value="Add Filtro" /></td>
        <td><input type="submit" name="desativar_filtros" value="Desativar Filtro" /></td>
        <td><input type="submit" name="ativar_filtros" value="Ativar Filtro" /></td>
        </form>
        </table>');
    }
    ...
    if (isset($_POST['desativar_filtros']) || isset($_SESSION['desativar_filtros'])) {
        ...
        if(isset(\$_POST[\'" . $nomes_itens[$l] . $i . "\'])){
            ...
            sql(\"INSERT INTO `historico_adm`(`nome`,`id_adm`, `item`, `status`, `data_add`) VALUES (\'" . $valores[$i] . "\',\'' . $_SESSION['usuario'] . '\',\'filtros\',\'desativado\',\'\".date(\'d/m/Y H:i:s\').\"\')\");
            reload(\'painel.php\');
        }";';

        $result = tabela($array_nome, [], ['Filtros', ' '], ['submit'], ['Desativar'], $php);
        echo ($result[0]);
        eval($result[1]);
    ...
    if (isset($_POST['ativar_filtros']) || isset($_SESSION['ativar_filtros'])) {
        ...
        if(isset(\$_POST[\'" . $nomes_itens[$l] . $i . "\'])){
            ...
            sql(\"INSERT INTO `historico_adm`(`nome`,`id_adm`, `item`, `status`, `data_add`) VALUES (\'" . $valores[$i] . "\',\'' . $_SESSION['usuario'] . '\',\'filtros\',\'ativo\',\'\".date(\'d/m/Y H:i:s\').\"\')\");
            reload(\'painel.php\');
        }";';

        $result = tabela($array_nome, [], ['Filtros', ' '], ['submit'], ['Ativar'], $php);
        echo ($result[0]);
        eval($result[1]);
    ...
    if (isset($_POST['add_filtros']) || isset($_SESSION['add_filtros'])) {
        ...
        <td><input type="text" placeholder="Insira o nome do novo Filtros" name="filtros_nome"></td>
    ...
    if (isset($_POST['add_filtros1'])) {
        if ($_POST['filtros_nome'] != '') {
            ...
            if (!mysqli_num_rows($result)) {
                sql("INSERT INTO `filtros`(`individuo`, `data_hora_add`,`nome`, `status`) VALUES ('" . $_SESSION['usuario'] . "','" . date('d/m/Y H:i:s') . "','" . $_POST['filtros_nome'] . "','ativo')");
...
if (true) { //empreendimento
    ...
    if (isset($_POST['desativar_empreendimento']) || isset($_SESSION['desativar_empreendimento'])) {
        ...
        $array_id_empresa = select_lin('empreendimentos', 'empresa_id', '`status` = \'ativo\'');
        $array_empresa = [];
    ...
    if(isset(\$_POST[\'" . $nomes_itens[$l] . $i . "\'])){
        ...
        sql(\"INSERT INTO `historico_adm`(`info_mais`,`nome`,`id_adm`, `item`, `status`, `data_add`) VALUES (\'\".\$id[0].\"\',\'" . $valores[$i] . "\',\'' . $_SESSION['usuario'] . '\',\'empreendimento\',\'desativado\',\'\".date(\'d/m/Y H:i:s\').\"\')\");
        reload(\'painel.php\');
    }";';
        ...
        $result = tabela($array_nome, $array_empresa, ['Empreendimentos', 'Empresas', ' '], ['submit'], ['Desativar'], $php);
        echo ($result[0]);
        eval($result[1]);
    ...
    if (isset($_POST['ativar_empreendimento']) || isset($_SESSION['ativar_empreendimento'])) {
        ...
        $array_id_empresa = select_lin('empreendimentos', 'empresa_id', '`status` = \'desativado\'');
        $array_empresa = [];
        for ($i = 0; $i < count($array_id_empresa); $i++) {
            array_push($array_empresa, select_lin('empresa', 'nome', '`id` = \'' . $array_id_empresa[$i] . '\'')[0]);
        }
    ...
    if(isset(\$_POST[\'" . $nomes_itens[$l] . $i . "\'])){
        ...
        sql(\"INSERT INTO `historico_adm`(`info_mais`,`nome`,`id_adm`, `item`, `status`, `data_add`) VALUES (\'\".\$id[0].\"\',\'" . $valores[$i] . "\',\'' . $_SESSION['usuario'] . '\',\'empreendimento\',\'ativo\',\'\".date(\'d/m/Y H:i:s\').\"\')\");
        reload(\'painel.php\');
    }";';
        $result = tabela($array_nome, $array_empresa, ['Empreendimentos', 'Empresas', ' '], ['submit'], ['Ativar'], $php);
        echo ($result[0]);
        eval($result[1]);
    }
    ...
    if (isset($_POST['add_empreendimento']) || isset($_SESSION['add_empreendimento'])) {
        ...
        echo ('<form action="" method="POST">  
        <table border="1" cellspacing="0" class="relative"cellpadding="5"><form action="" method="POST"><tr></tr><tr><td>Nome</td><td>Empresa</td><td></td></tr><tr>                       
        <td><input type="text" placeholder="Insira o nome do novo Empreendimento" name="empreendimento_nome"></td>
    ...
    if (isset($_POST['add_empreendimento1'])) {
        if ($_POST['empreendimento_empresa'] != 'Nada') {
            if ($_POST['empreendimento_nome'] != '') {
                ...
                if (!mysqli_num_rows($result)) {
                    sql("INSERT INTO `empreendimentos`(`individuo`, `data_hora_add`,`nome`, `empresa_id`, `status`) VALUES ('" . $_SESSION['usuario'] . "','" . date('d/m/Y H:i:s') . "','" . $_POST['empreendimento_nome'] . "','" . $id[0] . "','ativo')");
                    //$_SESSION = ['usuario' => $_SESSION['usuario']];
                    reload('painel.php');
                } else {
...
if (true) { //empresa
    if (isset($_POST['empresa']) || isset($_SESSION['empresa'])) {
        echo ('<table  cellspacing="0" cellpadding="5">
        <form action="" method="post" enctype="multipart/form-data"><tr>
        <td><input type="submit" name="add_empresa" value="Add Empresa" /></td>
        <td><input type="submit" name="desativar_empresa" value="Desativar Empresa" /></td>
        <td><input type="submit" name="ativar_empresa" value="Ativar Empresa" /></td>
        </form>
        </table>');
    }
    ...
    if (isset($_POST['desativar_empresa']) || isset($_SESSION['desativar_empresa'])) {
        ...
        if(isset(\$_POST[\'" . $nomes_itens[$l] . $i . "\'])){
            ...
            sql(\"INSERT INTO `historico_adm`(`nome`,`id_adm`, `item`, `status`, `data_add`) VALUES (\'" . $valores[$i] . "\',\'' . $_SESSION['usuario'] . '\',\'empresa\',\'desativado\',\'\".date(\'d/m/Y H:i:s\').\"\')\");
            reload(\'painel.php\');
        }";';

        $result = tabela($array_nome, [], ['Empresas', ' '], ['submit'], ['Desativar'], $php);
        echo ($result[0]);
        eval($result[1]);
    ...
    if (isset($_POST['ativar_empresa']) || isset($_SESSION['ativar_empresa'])) {
        ...
        if(isset(\$_POST[\'" . $nomes_itens[$l] . $i . "\'])){
            ...
            sql(\"INSERT INTO `historico_adm`(`nome`,`id_adm`, `item`, `status`, `data_add`) VALUES (\'" . $valores[$i] . "\',\'' . $_SESSION['usuario'] . '\',\'empresa\',\'ativo\',\'\".date(\'d/m/Y H:i:s\').\"\')\");
            reload(\'painel.php\');
        }";';

        $result = tabela($array_nome, [], ['Empresas', ' '], ['submit'], ['Ativar'], $php);
        echo ($result[0]);
        eval($result[1]);
    ...
    if (isset($_POST['add_empresa']) || isset($_SESSION['add_empresa'])) {
        ...
        echo ('<form action="" method="POST">
        <table border="1" cellspacing="0" class="relative"cellpadding="5"><form action="" method="POST"><tr></tr><tr><td>Nome</td><td></td></tr><tr>                          
        <td><input type="text" placeholder="Insira o nome da nova Empresa" name="empresa_nome"></td>
    ...
    if (isset($_POST['add_empresa1'])) {
        if ($_POST['empresa_nome'] != '') {
            ...
            if (!mysqli_num_rows($result)) {
                sql("INSERT INTO `empresa`(`individuo`, `data_hora_add`,`nome`, `status`) VALUES ('" . $_SESSION['usuario'] . "','" . date('d/m/Y H:i:s') . "','" . $_POST['empresa_nome'] . "','ativo')");
                //$_SESSION = ['usuario' => $_SESSION['usuario']];
                reload('painel.php');
            } else {
                alert('ja existe uma empresa com esse nome \nobs:verifique as empresas desativadas');
            }
...
if (true) { //prioridade
    ...
    if (isset($_POST['desativar_prioridade']) || isset($_SESSION['desativar_prioridade'])) {
        ...
        if(isset(\$_POST[\'" . $nomes_itens[$l] . $i . "\'])){
            ...
            sql(\"INSERT INTO `historico_adm`(`nome`,`id_adm`, `item`, `status`, `data_add`) VALUES (\'" . $valores[$i] . "\',\'' . $_SESSION['usuario'] . '\',\'prioridade\',\'desativado\',\'\".date(\'d/m/Y H:i:s\').\"\')\");
            reload(\'painel.php\');
        }";';
    ...
    if (isset($_POST['ativar_prioridade']) || isset($_SESSION['ativar_prioridade'])) {
        ...
        if(isset(\$_POST[\'" . $nomes_itens[$l] . $i . "\'])){
            ...
            sql(\"INSERT INTO `historico_adm`(`nome`,`id_adm`, `item`, `status`, `data_add`) VALUES (\'" . $valores[$i] . "\',\'' . $_SESSION['usuario'] . '\',\'prioridade\',\'ativo\',\'\".date(\'d/m/Y H:i:s\').\"\')\");
            reload(\'painel.php\');
        }";';
    ...
    if (isset($_POST['add_prioridade']) || isset($_SESSION['add_prioridade'])) {
        ...
        echo ('<form action="" method="POST">  
        <table border="1" cellspacing="0" class="relative"cellpadding="5"><form action="" method="POST"><tr></tr><tr><td>Nome</td><td></td></tr><tr>                       
        <td><input type="text" placeholder="Insira o nome da nova Prioridade" name="prioridade_nome"></td>
    ...
    if (isset($_POST['add_prioridade1'])) {
        if ($_POST['prioridade_nome'] != '') {
            ...
            if (!mysqli_num_rows($result)) {
                sql("INSERT INTO `prioridade`(`individuo`, `data_hora_add`,`nome`, `status`) VALUES ('" . $_SESSION['usuario'] . "','" . date('d/m/Y H:i:s') . "','" . $_POST['prioridade_nome'] . "','ativo')");
                //$_SESSION = ['usuario' => $_SESSION['usuario']];
                reload('painel.php');
            } else {
...
if (true) { //finalidade
    ...
    if (isset($_POST['desativar_finalidade']) || isset($_SESSION['desativar_finalidade'])) {
        ...
        if(isset(\$_POST[\'" . $nomes_itens[$l] . $i . "\'])){
            ...
            sql(\"INSERT INTO `historico_adm`(`nome`,`id_adm`, `item`, `status`, `data_add`) VALUES (\'" . $valores[$i] . "\',\'' . $_SESSION['usuario'] . '\',\'finalidade\',\'desativado\',\'\".date(\'d/m/Y H:i:s\').\"\')\");
            reload(\'painel.php\');
        }";';
    ...
    if (isset($_POST['ativar_finalidade']) || isset($_SESSION['ativar_finalidade'])) {
        ...
        if(isset(\$_POST[\'" . $nomes_itens[$l] . $i . "\'])){
            ...
            sql(\"INSERT INTO `historico_adm`(`nome`,`id_adm`, `item`, `status`, `data_add`) VALUES (\'" . $valores[$i] . "\',\'' . $_SESSION['usuario'] . '\',\'finalidade\',\'ativo\',\'\".date(\'d/m/Y H:i:s\').\"\')\");
            reload(\'painel.php\');
        }";';
    ...
    if (isset($_POST['add_finalidade']) || isset($_SESSION['add_finalidade'])) {
        ...
        echo ('<form action="" method="POST">   
        <table border="1" cellspacing="0" class="relative"cellpadding="5"><form action="" method="POST"><tr></tr><tr><td>Nome</td><td></td></tr><tr>                      
        <td><input type="text" placeholder="Insira o nome da nova Finalidade" name="finalidade_nome"></td>
    ...
    if (isset($_POST['add_finalidade1'])) {
        if ($_POST['finalidade_nome'] != '') {
            ...
            if (!mysqli_num_rows($result)) {
                sql("INSERT INTO `finalidade`(`individuo`, `data_hora_add`,`nome`, `status`) VALUES ('" . $_SESSION['usuario'] . "','" . date('d/m/Y H:i:s') . "','" . $_POST['finalidade_nome'] . "','ativo')");
                //$_SESSION = ['usuario' => $_SESSION['usuario']];
                reload('painel.php');
            } else {
...
if (true) { //usuarios
    if (isset($_POST['usuarios']) || isset($_SESSION['usuarios'])) {
        echo ('<table  cellspacing="0" cellpadding="5">
        <form action="" method="post" enctype="multipart/form-data"><tr>
        <td><input type="submit" name="add_usuarios" value="Add Usuarios" /></td>
        <td><input type="submit" name="desativar_usuarios" value="Desativar Usuarios" /></td>
        <td><input type="submit" name="ativar_usuarios" value="Ativar Usuarios" /></td>
        </form>
        </table>');
    }
    ...
    if (isset($_POST['desativar_usuarios']) || isset($_SESSION['desativar_usuarios'])) {
        ...
        $array_tipo = select_lin('usuarios', 'tipo', '`status` = \'ativo\' and `nome` != \'' . $_SESSION['usuario'] . '\'');

        $php = '"
        if(isset(\$_POST[\'" . $nomes_itens[$l] . $i . "\'])){
            sql(\"UPDATE `usuarios` SET `status`=\'desativado\' WHERE `nome`=\'" . $valores[$i] . "\' \");
            sql(\"INSERT INTO `historico_adm`(`nome`,`id_adm`, `item`, `status`, `data_add`) VALUES (\'" . $valores[$i] . "\',\'' . $_SESSION['usuario'] . '\',\'usuario\',\'desativado\',\'\".date(\'d/m/Y H:i:s\').\"\')\");
            reload(\'painel.php\');
        }";';
    ...
    if (isset($_POST['ativar_usuarios']) || isset($_SESSION['ativar_usuarios'])) {
        ...
        $array_tipo = select_lin('usuarios', 'tipo', '`status` = \'desativado\'');


        $php = '"
        if(isset(\$_POST[\'" . $nomes_itens[$l] . $i . "\'])){
            sql(\"UPDATE `usuarios` SET `status`=\'ativo\' WHERE `nome`=\'" . $valores[$i] . "\' \");
            sql(\"INSERT INTO `historico_adm`(`nome`,`id_adm`, `item`, `status`, `data_add`) VALUES (\'" . $valores[$i] . "\',\'' . $_SESSION['usuario'] . '\',\'usuario\',\'ativo\',\'\".date(\'d/m/Y H:i:s\').\"\')\");
            reload(\'painel.php\');
        }";';
    ...
    if (isset($_POST['add_usuarios']) || isset($_SESSION['add_usuarios'])) {
        ...
        <td><input type="text" placeholder="Nome do novo usuario" name="usuarios_nome"></td>
    ...
    if (isset($_POST['add_usuarios1'])) {
        if ($_POST['usuario_clase'] != 'Nada') {
            if ($_POST['usuarios_nome'] != '') {
                if ($_POST['usuarios_senha'] != '') {
                    $result = sql("SELECT * FROM `usuarios` WHERE `nome` = '" . $_POST['usuarios_nome'] . "'");
                    if (!mysqli_num_rows($result)) {
                        sql("INSERT INTO `usuarios`(`individuo`, `data_hora_add`,`nome`,`senha`,`tipo`, `status`)VALUES ('" . $_SESSION['usuario'] . "','" . date('d/m/Y H:i:s') . "','" . $_POST['usuarios_nome'] . "',md5('" . $_POST['usuarios_senha'] . "'),'" . $_POST['usuario_clase'] . "','ativo')");
                        //$_SESSION = ['usuario' => $_SESSION['usuario']];
                        reload('painel.php');
                    } else {
...
if (true) { //desenho
    ...
    if (isset($_POST['corte_desenho']) || isset($_SESSION['corte_desenho'])) {
        ...
        $result .= '<tr><td>Desenhista</td><td>Caminho</td><td>Nome do arquivo</td><td>Prioridade</td><td>Finalidade</td><td>Empresa</td>
        ...
        for ($i = 0; $i < count($array_nome); $i++) {
            ...
            sql(\"INSERT INTO `historico_desenhos`(`status`,`id_desenhos`, `nome`, `data_hora_add`, `data_hora_mod`,`individuo`) VALUES ('\".\$status.\" => corte','\".\$id.\"','" . $array_nome[$i][0] . "','\".\$data_hora.\"','\".date('d/m/Y H:i:s').\"','" . $_SESSION['usuario'] . "')\");
             sql(\"UPDATE `desenhos` SET `nome`='\".\$arquivo['name'].\"' WHERE `desenhista` = '\".\$_SESSION['usuario'].\"' and `nome` = '" . $array_nome[$i][0] . "' and `caminho` = '" . $array_caminho[$i][0] . "';\");
                  
                }reload('painel.php'); 
            }else{
                
                
                sql(\"INSERT INTO `violacao`( `individuo`, `causa`, `data`) VALUES ('" . $_SESSION['usuario'] . "','Tentou subistituir uma deseho(id = \".\$id.\") com um arquivo não permitido, arquivo(\".\$arquivo['name'].\"), local(" . $array_caminho[$i][0] . ")','\".date('d/m/Y H:i:s').\"')\");
            ...
            sql(\"INSERT INTO `historico_desenhos`(`status`,`id_desenhos`, `nome`, `data_hora_add`, `data_hora_mod`,`individuo`) VALUES ('\".\$status.\" => apagado','\".\$id.\"','" . $array_nome[$i][0] . "','\".\$data_hora.\"','\".date('d/m/Y H:i:s').\"','" . $_SESSION['usuario'] . "')\");
            sql(\"UPDATE `desenhos` SET `status` = 'apagado' WHERE `nome` = '" . $array_nome[$i][0] . "' and `caminho` = '" . $array_caminho[$i][0] . "';\");
            sql(\"INSERT INTO `lixo_desenhos`( `id_desenho`, `caminho`, `nome_desenho`, `data_add`, `individuo`) VALUES ('\".\$id.\"','\".lixo_desenho(\$caminho,\$nome).\"','\".\$nome.\"','\".date('d/m/Y H:i:s').\"','" . $_SESSION['usuario'] . "')\");
            reload('painel.php');
                }
    ...
    if (isset($_POST['cortados_desenho']) || isset($_SESSION['cortados_desenho'])) {
        ...
        $result .= '<tr><td>Desenhista</td><td>Cortador</td><td>Caminho</td><td>Nome do arquivo</td><td>Prioridade</td><td>Finalidade</td><td>Empresa</td>
        <td>Empreendimento</td>
    ...
    if (isset($_POST['relatorio_desenho']) || isset($_SESSION['relatorio_desenho'])) {
        ...
        <td><select  name="desenho_mes" >' . cascata_lin([['00'], ['01'], ['02'], ['03'], ['04'], ['05'], ['06'], ['07'], ['08'], ['09'], ['10'], ['11'], ['12']]) . '</select></td>
    ...
    if (isset($_POST['relatorio_desenho1'])) {
        ...
        $data = '';
        if ($_POST['desenho_mes'] != '00') {
            $data .= 'do mês ' . $_POST['desenho_mes'];
        }
        if ($_POST['desenho_mes'] != '00' && $_POST['desenho_ano'] != '') {
            $data .= ' ano de ';
        }
        ...
        if (true) { //all desenho
            ...
            $html .= '<tr></tr><tr><td>Desenhista</td><td>Nome desenho</td><td>Empresa</td><td>Empreendimento</td><td>Finalidade</td><td>Prioridade</td><td>Data adicionado</td><td>Cortador</td><td>Data do Corte</td><td>Tempo do corte</td></tr>';
        ...
        if (true) { //all desenhos cortados
            ...
            $html .= '<table width=70% border="1" cellspacing="0" cellpadding="5"><form action="" method="POST">';
            $html .= '<tr></tr><tr><td>Cortador</td><td>Desenhista</td><td>Nome desenho</td><td>Empresa</td><td>Empreendimento</td><td>Finalidade</td><td>Prioridade</td><td>Data adicionado</td><td>Data do Corte</td><td>Tempo do corte</td></tr>';
        ...
        if (true) { //adm
            for ($i = 0; $i < count($array_id_adm); $i++) {
                ...
                if ($empresa_add != []) {
                    $html .= '<br/><br/>';
                    $html .= '<h3>Empresa add por ' . $array_id_adm[$i] . '</h3>';
                    $html .= '<table width=70% border="1" cellspacing="0" cellpadding="5"><form action="" method="POST">';
                    $html .= '<tr></tr><tr><td>Empresa</td><td>Data</td></tr>';
                ...
                if ($filtros_add != []) {
                    $html .= '<br/><br/>';
                    $html .= '<h3>Filtro add por ' . $array_id_adm[$i] . '</h3>';
                    $html .= '<table width=70% border="1" cellspacing="0" cellpadding="5"><form action="" method="POST">';
                    $html .= '<tr></tr><tr><td>Filtro</td><td>Data</td></tr>';
                ...
                if ($empreendimento_add != []) {
                    ...
                    $html .= '<table width=70% border="1" cellspacing="0" cellpadding="5"><form action="" method="POST">';
                    $html .= '<tr></tr><tr><td>Empresa</td><td>Empreendimento</td><td>Data</td></tr>';
