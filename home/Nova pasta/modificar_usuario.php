...
if (isset($_GET['id'])) {
    ...
    if($ativo=="Ativo"){
        $ativo = '<input type = "checkbox" id = "subscribeNews" name = "Ativar"  checked> Ativado';
    }else{
   ...
   <p>Whatzap</br>
    ...
    <p><input name="botao_atualizar" value="Atualizar Conta" onclick="Atualizar_fechar()" type="submit"> </p>
